...
function Product(){
 ...
 useEffect(()=>{if(user&&restrictedToSupplierNetwork&&!['/supplier-network','/rfps'].includes(route.path))navigate('supplier-network')},[user,restrictedToSupplierNetwork,route.path])
 ...
 else if(route.path==='/supplier-network')page=<SupplierNetworkPage route={route} onToast={setToast}/>
 else if(route.path==='/rfps')page=<RfpsPage route={route} onToast={setToast}/>
